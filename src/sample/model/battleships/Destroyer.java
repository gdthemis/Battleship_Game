...
public class Destroyer extends Ship {
    ...
    public int points_per_heat = 50;
    public int bonus = 0;
    public int space = 2;
    public int points = 0;

    public Destroyer(boolean not_touched, boolean hit, boolean sinked) {
...
//            System.out.println(orientation);
            ...
            if (orientation == 1) {
                for (int i = 0; i < space; i++) {
                    ...
                    grid.get_cell(x, y + i).setContains(5);
                }
            }
            else {
                for (int i = 0; i < space; i++) {
                    ...
                    grid.get_cell(i + x, y).setContains(5);
                }
            }
        } catch (Exception e) {
            e.printStackTrace();
