...
public class Cruiser extends Ship {
    ...
    public int bonus = 250;
    public int space = 3;
    public int points = 0;

    public Cruiser(boolean not_touched, boolean hit, boolean sinked) {
    ...
    public void set (Grid grid, int x, int y, int orientation) {
        try {
...
//            System.out.println(orientation);
            ...
            if (orientation == 1) {
                for (int i = 0; i < space; i++) {
                    ...
                    grid.get_cell(x, y + i).setContains(3);
                }
            }
            else {
                for (int i = 0; i < space; i++) {
                    ...
                    grid.get_cell(i + x, y).setContains(3);
                }
            }
        } catch (Exception e) {
            e.printStackTrace();
